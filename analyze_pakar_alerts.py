...
parser.add_argument("--min-pre",  type=float, default=0.5,  help="Min minutes: warning → missile")
parser.add_argument("--max-pre",  type=float, default=30.0, help="Max minutes: warning → missile")
parser.add_argument("--min-post", type=float, default=2.0,  help="Min minutes: missile → ended")
parser.add_argument("--max-post", type=float, default=90.0, help="Max minutes: missile → ended")
